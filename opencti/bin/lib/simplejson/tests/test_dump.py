...
class TestDump(TestCase):
    ...
    def test_bytes_toplevel(self):
        ...
        if PY3:
            ...
            self.assertEqual(json.dumps(b("\xe2\x82\xac"), encoding=None), r'"\u20ac"')
            self.assertRaises(UnicodeDecodeError, json.dumps, b("\xa4"), encoding=None)
            self.assertRaises(
                UnicodeDecodeError,
                json.dumps,
                b("\xa4"),
    ...
    def test_bytes_key(self):
        ...
        if PY3:
            ...
            self.assertEqual(
                json.dumps({b("\xe2\x82\xac"): 42}, encoding=None), r'{"\u20ac": 42}'
            )
            self.assertRaises(
