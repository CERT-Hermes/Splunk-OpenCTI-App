...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "[foo:bar = 1] START '1932-11-12T15:42:15Z' STOP '1964-10-53T21:12:26Z'",
            set(["START '1932-11-12T15:42:15Z' STOP '1964-10-53T21:12:26Z'"]),
        ),
        (
            "[foo:bar = 1] REPEATS 1 TIMES REPEATS 2 TIMES",
            set(["REPEATS 1 TIMES", "REPEATS 2 TIMES"]),
        ),
        (
        ...
        (
            "([foo:bar = 1] START '1932-11-12T15:42:15Z' STOP '1964-10-53T21:12:26Z' AND [foo:abc < h'12ab']) WITHIN 22 SECONDS "
            "OR [frob:baz NOT IN (1,2,3)] REPEATS 31 TIMES",
            set(
                [
                    "START '1932-11-12T15:42:15Z' STOP '1964-10-53T21:12:26Z'",
                    "WITHIN 22 SECONDS",
                    "REPEATS 31 TIMES",
                ]
            ),
