...
class CounterMetricFamily(Metric):
    ...
    def __init__(
        self, name, documentation, value=None, labels=None, created=None, unit=""
    ):
...
class HistogramMetricFamily(Metric):
    ...
    def __init__(
        self, name, documentation, buckets=None, sum_value=None, labels=None, unit=""
    ):
...
class GaugeHistogramMetricFamily(Metric):
    ...
    def __init__(
        self, name, documentation, buckets=None, gsum_value=None, labels=None, unit=""
    ):
